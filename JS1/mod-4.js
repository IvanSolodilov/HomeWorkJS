...
console.log("Весь массив: " + d1);
console.log(`Элемент d1[6] = ${d1[6]}, Элемент d1[7] = ${d1[7]}`);
...
console.log(`Сумма чисел в массиве: ${sum2}`);
...
console.log(`Сумма чисел массива: ${sum3}`);
...
console.log(`Сортировка массива по убыванию: ${d4.sort(my)}`);

...
let unit = prompt("В чем измеряем? (Кб, Мб, Гб) ");

// // наверное тут можно было бы сделать через if но я попробовал так

switch(unit) {
    case "Кб": console.log("В байтах это будет: " + size * 1024);
    break; 
    case "Мб": console.log("В байтах это будет: " + size * 1000000);
    break; 
    case "Гб": console.log("В байтах это будет: " + size * 1e+9);
    break; 
}
